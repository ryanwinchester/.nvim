...
require('lazy').setup {
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        --   cmd = { "/Users/ryanwinchester/forks/lexical/_build/dev/package/lexical/bin/start_lexical.sh" },
        --   settings = {},
        -- },
      }
  ...
  -- CATPUCCIN (Doesn't work at all, why?)
  -- {
  --   'catppuccin/nvim',
  --   name = 'catppuccin',
  --   lazy = false,
  ...
  -- NOIRBUDDY (doesn't work well with elixir)
  -- {
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'elixir', 'erlang', 'heex', 'html', 'lua', 'markdown', 'vim', 'vimdoc' },
...
-- Fix swapfile shennanagins hopefuly (from teej_dv)
